export default function Faq() {
    return (
        <section id="faq" class="bg-white dark:bg-gray-900 pt-10">
                ...
                <div class="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
                    <div>
                        ...
                        <div class="mb-10">
                            ...
                            <p class="text-gray-500 dark:text-gray-400">Find out more information by <a to="/license" class="font-medium underline text-primary-600 dark:text-primary-500 hover:no-underline">reading the license</a>.</p>
                        </div>
                    </div>
                    <div>
                        <div class="mb-10">
